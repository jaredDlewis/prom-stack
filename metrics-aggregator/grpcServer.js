...
function getServer() {
  ...
  server.addService(MetricsService.service, {
    ...
    Export: (call, callback) => {
      ...
      const containerId = containerIdAttr.value.string_value;
      ...
      const containerMemoryUsageTotal = memoryUsageMetrics.sum.data_points[0].as_int;

      console.log('containerMemoryUsageTotal', containerMemoryUsageTotal)
      console.log('\n');
      callback(null, {});
    },
  });
